            ...
            <table class="table table-bordered" style=" background-color: #fff;   border-collapse: collapse;
                ...
                <tbody style="opacity: .9;">
                    <tr>
                        ...
                        <td><%= p.getDuracion()%></td>
                        <td><%= p.getGenero()%></td>
                        <td id="aforo"><%= p.getAforo()%></td>
                        <td><%= p.getSala()%></td>
                        <td><%= p.getHora()%></td>
                        <td>
                            <a class="btn btn-warning" href="Controlador?accion=reservar&id=<%= p.getId()%>&aforo=<%= p.getAforo()%>" onclick="return mensajeReservar(<%= p.getAforo()%>);">Reservar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
